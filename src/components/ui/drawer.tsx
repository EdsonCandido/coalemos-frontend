...
function DrawerContent({ className, children, widthDesktop = "40vw", ...props }: DrawerContentProps) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      <DrawerOverlay />
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:w-full", // mobile full width
          `md:data-[vaul-drawer-direction=right]:w-[${widthDesktop}]`, // desktop responsivo
          // Left
          ...
          `md:data-[vaul-drawer-direction=left]:w-[${widthDesktop}]`,
          className
        )}
        {...props}
      >
