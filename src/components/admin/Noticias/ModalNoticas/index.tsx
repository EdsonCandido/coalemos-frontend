...
const ModalNoticias = ({
  ...
  const onSubmit = async () => {
    ...
    let isInvalid = false
    if (titulo.length < 1) {
      toast.warn('Título da Noticia não pode ser vazio', {
        position: 'top-left',
      })
      isInvalid = true
    }
    ...
    if (!isEditModal) {
      ...
      if (!arquivo_conteudo) {
        toast.warn('Você deve anexar uma imagem de conteúdo', {
          position: 'top-left',
        })
        isInvalid = true
      }
  ...
  return (
    ...
    >
      ...
      <DrawerContent>
        <DrawerCloseButton />
        <DrawerHeader as="p">
          {noticiaId ? 'Editar Notícia' : 'Novo Notícia'}
        </DrawerHeader>
        <DrawerBody>
          {isLoading ? (
            <Loading />
            ...
            <Flex w={'100%'} p={1} gap={1} flexDir={'column'}>
              ...
              >
                ...
                {capa64 && (
                  ...
                  >
                    <Image
                      src={`data:image/jpg;base64,${capa64}`}
                      alt="capa"
                      width={'80%'}
                    />
                  </Flex>
                ...
                {conteudo64 && (
                  ...
                  >
                    <Image
                      src={`data:image/jpg;base64,${conteudo64}`}
                      alt="conteudo"
                      width={'100%'}
                    />
                  </Flex>
