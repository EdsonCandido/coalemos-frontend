...
const ModalUsuario = ({ onSuccess, isOpen, userId, setIsOpenModal, setUserId }: Input) => {
  ...
  const onSubmit = async () => {
    ...
    const payload = {
      ...
      is_ativo: isActive ? true : false,
      is_primeiro_acesso: primeiroAcesso ? true : false,
      login: loginTxt,
      senha: passwordTxt,
      nome: nomeCompleto,
      foto_perfil: null,
          ...
          {isLoading ? (
            ...
            <Flex w={'100%'} p={1} gap={1} flexDir={'column'}>
              ...
              <Flex w={'100%'} p={1} gap={1} flexDir={'column'}>
                ...
                />
                {!validLoginState && <span style={{ color: 'red' }}>Login já cadastrado</span>}
              </Flex>
              {/*<Flex w={"100%"} p={1} gap={1} flexDir={"column"}>
                <Flex>
                  <Text>CPF</Text>
              ...
              <Flex gap={3} p={1}>
                ...
                <Checkbox
                  isDisabled={isLoadingSubmit}
                  value={primeiroAcesso ? 1 : 0}
                  defaultChecked={primeiroAcesso}
        ...
        <DrawerFooter>
          {!isLoading && (
            <>
              ...
              <Button colorScheme="blue" onClick={onSubmit} disabled={!validLoginState}>
                Salvar
              </Button>
            </>
          )}
